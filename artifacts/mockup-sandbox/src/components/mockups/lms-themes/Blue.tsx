...
const sidebar = { bg: "#071428", accent: "#3b82f6", accentLight: "#3b82f622", nav: "#0d1f3c", text: "#a8bcd8", textMuted: "#4d6080", border: "#0d1f3c" };
const content = { bg: "#eef2f9", card: "#ffffff", border: "#dde5f0", text: "#0c1a2e", muted: "#5a7290", primary: "#3b82f6", primaryLight: "#3b82f618" };
...
const stats = [
  { label: "Courses Enrolled", value: "12", delta: "+2 this week", icon: BookOpen, color: "#3b82f6" },
