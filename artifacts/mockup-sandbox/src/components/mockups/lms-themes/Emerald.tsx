...
// Theme 3: Slate + Vivid Indigo
const S = { bg: "#1e2035", accent: "#6366f1", accentBg: "#6366f118", row: "#272a45", text: "#a5b4d4", muted: "#5a6a8a", border: "#2d3154" };
const C = { bg: "#f1f2fb", card: "#ffffff", border: "#e0e2f5", text: "#111230", muted: "#6070a0", primary: "#6366f1", primaryBg: "#6366f110" };
...
const stats = [
  { label: "Courses Enrolled", value: "12", delta: "+2 this week", icon: BookOpen, color: "#6366f1" },
  ...
  { label: "Streak", value: "7 days", delta: "Personal best!", icon: TrendingUp, color: "#10b981" },
];
      ...
      <div style={{ width:220, background:S.bg, display:"flex", flexDirection:"column", borderRight:`1px solid ${S.border}`, flexShrink:0 }}>
        <div style={{ padding:"20px 16px 16px", borderBottom:`1px solid ${S.border}` }}>
          <div style={{ display:"flex", alignItems:"center", gap:10 }}>
            <div style={{ width:32, height:32, borderRadius:8, background:S.accent, display:"flex", alignItems:"center", justifyContent:"center" }}><Zap size={16} color="#fff" /></div>
        ...
        <div style={{ padding:"8px", borderTop:`1px solid ${S.border}` }}>
          ...
          <div style={{ display:"flex", alignItems:"center", gap:9, padding:"10px", borderRadius:8, background:S.row }}>
            <div style={{ width:30, height:30, borderRadius:"50%", background:S.accent, display:"flex", alignItems:"center", justifyContent:"center", color:"#fff", fontSize:12, fontWeight:700 }}>A</div>
