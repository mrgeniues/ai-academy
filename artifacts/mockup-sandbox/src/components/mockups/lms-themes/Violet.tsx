...
// Theme 1: Charcoal + Cyan
const S = { bg: "#1c2028", accent: "#06b6d4", accentBg: "#06b6d414", row: "#252b35", text: "#b8c5d6", muted: "#5a6a7e", border: "#2a3140" };
const C = { bg: "#f0f4f8", card: "#ffffff", border: "#e0e8f0", text: "#0d1520", muted: "#5a7090", primary: "#06b6d4", primaryBg: "#06b6d412" };
...
const stats = [
  { label: "Courses Enrolled", value: "12", delta: "+2 this week", icon: BookOpen, color: "#06b6d4" },
  { label: "Hours Learned", value: "48h", delta: "+6h this week", icon: Clock, color: "#8b5cf6" },
